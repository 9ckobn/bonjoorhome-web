...
const Hero = () => {
  ...
  return (
    <section
      id="home"
      className="section-padding bg-gradient-to-br from-primary-50 to-blue-50 min-h-screen flex items-center"
    >
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-center lg:text-left animate-fade-in">
            ...
            <p className="text-xl text-gray-600 mb-8 max-w-2xl">
              Уютные квартиры, дома и студии в лучших районах города. Комфортное
              проживание по доступным ценам.
            </p>
